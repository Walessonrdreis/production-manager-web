...
export function CollaboratorGoalsTab() {
  ...
  const openEditModal = (goal: ProductionGoal) => {
    setEditingGoal(goal);
    setSelectedCollabId(goal.collaboratorId || '');
          ...
          >
              ...
              <div>
                ...
                {collaborators.length === 0 && (
                  <p className="text-xs text-amber-600 mt-1 flex items-center gap-1">
                    ...
                    Adicione colaboradores na página de Colaboradores.
                  </p>
                )}
              </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button 
                ...
                disabled={!selectedCollabId || targetQty <= 0}
