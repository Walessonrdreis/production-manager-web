...
export function normalizeOrder(raw: any): Order {
  ...
  return {
    ...
    customerName: raw.clientTradeName || raw.clientName || raw.clientLegalName || raw.tradeName || raw.client?.tradeName || raw.client?.legalName || raw.customer?.tradeName || raw.customer?.legalName || raw.customerName || raw.customer_name || raw.cliente || raw.nome_cliente || 'Cliente Omie',
