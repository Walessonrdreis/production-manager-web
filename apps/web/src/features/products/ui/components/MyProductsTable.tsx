...
import { Package, Trash2, Edit, AlertTriangle, FilePlus2, Layers, CheckSquare } from 'lucide-react';
...
export function MyProductsTable({ products, demandMap = {}, onRemoveProduct, onViewDetails, onPlanProduct, onUpdateBulkMinStock }: MyProductsTableProps) {
